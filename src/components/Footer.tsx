      ...
      <div className="container-narrow">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <img src={logo} alt="LibertyLoft" className="h-6 w-auto opacity-70" />
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="https://github.com/libertyloft"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="text-muted-foreground hover:text-foreground transition-colors"
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>{t('footer.copyright')} · {t('footer.powered')} · <a href="https://github.com/libertyloft/libertyloft.cz" target="_blank" rel="noopener noreferrer">{t('footer.sourceCode')}</a></p>
        </div>
      </div>
    </footer>
  );
